 ...
 *  1. Deep lounge gradient base (warm near-black)
 *  2. Photographic-style radial light pools (overhead lamp simulation)
 *  3. Richly coloured warmth fills (mahogany/leather/amber)
 *  4. Vignette edges (cinema-grade depth)
 *  5. Fine film-grain texture
 *  6. Slow ambient smoke wisps (CSS animated)
 *  7. Top-center gold arc glow (branded accent)
 */
export function AmbientBackground() {
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-0" aria-hidden="true">

      {/* ── Layer 1: Deep warm base ─────────────────────────── */}
      <div className="absolute inset-0" style={{ background: "hsl(22 18% 4%)" }} />

      {/* ── Layer 2: Overhead lamp pools (luxury lounge lighting) ─ */}
      <div className="absolute inset-0" style={{
        background: `
          radial-gradient(ellipse 55% 35% at 50%   0%,  rgba(200,145,30,0.11)  0%, transparent 55%),
          radial-gradient(ellipse 30% 25% at 18%  15%,  rgba(160,100,20,0.07)  0%, transparent 50%),
          radial-gradient(ellipse 30% 25% at 82%  15%,  rgba(160,100,20,0.07)  0%, transparent 50%),
          radial-gradient(ellipse 20% 18% at 30%  55%,  rgba(120, 70,10,0.05)  0%, transparent 45%),
          radial-gradient(ellipse 20% 18% at 70%  55%,  rgba(120, 70,10,0.05)  0%, transparent 45%)
        `,
      }} />
      ...
      <div className="absolute inset-0" style={{
        background: `
          radial-gradient(ellipse 70% 50% at 75% 70%,  rgba(110, 60,15,0.09)  0%, transparent 60%),
          radial-gradient(ellipse 60% 45% at 25% 75%,  rgba( 90, 45,10,0.07)  0%, transparent 55%),
          radial-gradient(ellipse 80% 40% at 50% 100%, rgba( 80, 40, 8,0.12)  0%, transparent 50%)
        `,
      }} />
      ...
      {/* Top-corner edge darkening */}
      <div className="absolute inset-0" style={{
        background: `
          linear-gradient(180deg, rgba(0,0,0,0.35) 0%, transparent 18%),
          linear-gradient(0deg,   rgba(0,0,0,0.4)  0%, transparent 22%)
        `,
      }} />
      ...
      <div className="absolute top-0 left-0 right-0 h-px" style={{
        background: "linear-gradient(90deg, transparent, rgba(212,175,55,0.20), rgba(212,175,55,0.35), rgba(212,175,55,0.20), transparent)",
      }} />
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-96 h-64 pointer-events-none" style={{
        background: "radial-gradient(ellipse 100% 100% at 50% 0%, rgba(212,175,55,0.06) 0%, transparent 70%)",
      }} />
