 ...
 * Small loss: red drop
 * Auto-dismisses in 2s. pointer-events: none — fully non-blocking.
 */
...
export const XPFeedback: React.FC<XPFeedbackProps> = ({ amount, type, onComplete }) => {
  ...
  return (
    <div style={{
      ...
      {/* ── Big-loss: screen-edge red flash ── */}
      {!isGain && isBig && (
        <motion.div
          initial={{ opacity: 0 }}
      ...
      {/* ── Shimmer particles (big gain only) ── */}
