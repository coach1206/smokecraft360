...
export function LoginModal({ onClose, showClose = true }: LoginModalProps) {
  ...
  return (
    <motion.div
      ...
      style={{ background: "rgba(26,26,27,0.36)", backdropFilter: "blur(8px)" }}
    ...
    >
      <motion.div
        ...
        style={{
          ...
          border: "1px solid rgba(212,139,0,0.15)",
          boxShadow: "0 24px 64px rgba(26,26,27,0.32), 0 0 0 1px rgba(212,139,0,0.06) inset",
        }}
        initial={{ scale: 0.94, y: 16 }} animate={{ scale: 1, y: 0 }}
        transition={{ type: "spring", stiffness: 280, damping: 26 }}
      >
        {/* Gold shimmer top */}
        <div className="absolute top-0 left-0 right-0 h-px" style={{ background: "linear-gradient(90deg, transparent, rgba(212,139,0,0.4), transparent)" }} />
        ...
        <div className="p-8">
          ...
          <div className="flex items-start justify-between mb-8">
            <div>
              <div className="flex items-center gap-2 mb-1">
                <Shield size={14} style={{ color: "rgba(212,139,0,0.5)" }} />
                <span className="text-[9px] uppercase tracking-[0.3em]" style={{ color: "rgba(212,139,0,0.45)" }}>Partner Access</span>
              </div>
          ...
          {/* Tab switcher */}
          <div className="flex rounded-full p-0.5 mb-6" style={{ background: "rgba(26,26,27,0.06)", border: "1px solid rgba(26,26,27,0.09)" }}>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onFocus={(e) => (e.currentTarget.style.borderColor = "rgba(212,139,0,0.35)")}
              ...
              {submitting ? (
                <span className="flex items-center justify-center gap-2">
                  <motion.span className="inline-block w-4 h-4 border-2 rounded-full"
                    style={{ borderColor: "rgba(212,139,0,0.4)", borderTopColor: "rgba(212,139,0,0.8)" }}
  ...
  return (
    <div>
      ...
      <input
        ...
        style={{ background: "rgba(26,26,27,0.06)", border: "1px solid rgba(255,255,255,0.1)", color: "rgba(220,200,165,0.9)" }}
        onFocus={(e) => (e.currentTarget.style.borderColor = "rgba(212,139,0,0.35)")}
        onBlur={(e)  => (e.currentTarget.style.borderColor = "rgba(255,255,255,0.1)")}
      />
    </div>
