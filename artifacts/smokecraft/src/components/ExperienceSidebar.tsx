  ...
  return (
    ...
    >
      ...
      <div className="px-6 pt-7 pb-5">
        ...
        <div className="mt-3 h-px" style={{ background: "linear-gradient(90deg, rgba(212,175,55,0.4), transparent)" }} />
      </div>
            ...
            <motion.div
              ...
              style={{
                background: isActive
                  ...
                  : isCompleted ? "rgba(212,175,55,0.05)" : "transparent",
                border: isActive
            ...
            >
              ...
              {i > 0 && (
                <div className="absolute left-[27px] -top-0.5 w-px h-1"
                  style={{ background: isCompleted || isActive ? "rgba(212,175,55,0.30)" : "rgba(255,255,255,0.08)" }} />
              )}
              ...
              <div className="flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center"
                style={{
                  background: isActive
                    ? "linear-gradient(135deg, #b07c14, #D4AF37)"
                    : isCompleted ? "rgba(212,175,55,0.22)" : "rgba(255,255,255,0.07)",
                  border: isActive ? "none"
                    : isCompleted ? "1.5px solid rgba(212,175,55,0.45)"
                ...
                <AnimatePresence mode="wait">
                  {isCompleted ? (
                    <motion.span key="check"
                      ...
                      <Check size={14} style={{ color: "#D4AF37" }} strokeWidth={2.5} />
                    </motion.span>
                  ) : (
                    <motion.span key="num"
                      initial={{ opacity: 0 }} animate={{ opacity: 1 }}
                      style={{ fontSize: 12, fontWeight: 700, color: isActive ? "#1A1208" : "rgba(220,195,150,0.65)" }}>
                      {i + 1}
                    </motion.span>
                  )}
                </AnimatePresence>
              ...
              {isActive && (
                <motion.div className="absolute right-0 top-3 bottom-3 w-0.5 rounded-full"
                  style={{ background: "linear-gradient(180deg, transparent, rgba(212,175,55,0.7), transparent)" }}
