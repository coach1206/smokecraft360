      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ margin: "0 0 10px", fontSize: 14, lineHeight: 1.65, opacity: 0.85 }}>
            Access to the NOVEE OS demo environment is provided in strict confidence.
          ...
          <ol style={{ margin: 0, paddingLeft: 20, fontSize: 13, lineHeight: 1.7, opacity: 0.75 }}>
            ...
            <li>You will not reverse-engineer, decompile, or attempt to derive the source code, algorithms, or trade secrets of the NOVEE OS platform.</li>
            <li>All materials, screenshots, recordings, or notes taken during this session remain the intellectual property of Profound Innovations.</li>
