 ...
 * (the premium studio rewards the player's score achievement).
 */
    ...
    return (
      <div className="flex flex-col items-center gap-6 py-4">
        <div className="flex flex-col items-center gap-2 p-6 rounded-2xl w-full"
          ...
          <CigarBandPreview design={state.design} blendName={state.bandName || "My Signature"} style={state.style} size="lg" />
          <p className="text-[8px] uppercase tracking-[0.28em] mt-1" style={{ color: MUTED }}>Band Preview</p>
        </div>
        {state.boxEnabled && (
          <div className="flex flex-col items-center gap-2 p-6 rounded-2xl w-full"
            style={{ background: "rgba(0,0,0,0.35)", border: "1px solid rgba(255,255,255,0.05)" }}>
            <CigarBoxPreview
              ...
              size="md"
            />
            <p className="text-[8px] uppercase tracking-[0.28em] mt-1" style={{ color: MUTED }}>Box Preview</p>
          </div>
        )}
        {!state.boxEnabled && (
