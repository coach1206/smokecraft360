...
const VARIANT_MAP: Record<BadgeVariant, { fg: string; bg: string; border: string }> = {
  gold:   { fg: "#D48B00", bg: "rgba(212,139,0,0.14)",  border: "rgba(212,139,0,0.38)" },
  ...
  muted:  { fg: "rgba(240,232,212,0.48)", bg: "rgba(26,26,27,0.07)", border: "rgba(26,26,27,0.14)" },
  ghost:  { fg: "rgba(240,232,212,0.32)", bg: "transparent", border: "rgba(26,26,27,0.10)" },
};
