...
const BG: Record<string, BgState> = {
  ...
  flavor_smoky:         { filter: "brightness(0.38) saturate(1.25)",                    tint: "rgba(245,242,237,0.68)"   },
  ...
  flavor_smoke:         { filter: "brightness(0.36) saturate(1.2)",                     tint: "rgba(245,242,237,0.70)"   },
  ...
  mood_reflective:      { filter: "brightness(0.42) saturate(0.85)",                    tint: "rgba(245,242,237,0.62)"    },
