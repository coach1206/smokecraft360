  ...
  return (
    <div style={{ position: "relative", width: 96, height: 96, margin: "0 auto 28px" }}>
      ...
      <div style={{
        ...
        height:         "100%",
        borderRadius:   "50%",
        background:     `radial-gradient(135deg, ${accent}18 0%, rgba(245,242,237,0.7) 100%)`,
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        inset:           0,
        zIndex:          600,
        background:      `radial-gradient(ellipse at 50% 35%, ${accent}22 0%, rgba(8,5,2,0.0) 55%), linear-gradient(180deg, #0d0a06 0%, #080502 100%)`,
