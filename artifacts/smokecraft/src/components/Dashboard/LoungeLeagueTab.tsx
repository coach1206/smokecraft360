  ...
  if (mode !== "sovereign") {
    return (
      <SovereignLockOverlay
        variant="inline"
        featureName="Lounge League"
        description="The Lounge League competition leaderboard is a Sovereign-tier feature. Upgrade to view rankings, badges, and venue standings."
      />
    );
  }
