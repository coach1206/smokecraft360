    ...
    <div className="space-y-8">
      ...
      <div className="grid md:grid-cols-[220px_1fr] gap-6">
        ...
        <div className="space-y-2">
          <p className="text-[9px] uppercase tracking-[0.25em] mb-3" style={{ color: "rgba(180,155,100,0.4)" }}>
            Distributors
          </p>
              ...
              <button key={d.id} onClick={() => setSelectedDistId(selectedDistId === d.id ? null : d.id)}
                ...
                {d.state && (
                  <div className="flex items-center gap-1 mt-1">
                    <MapPin size={9} style={{ color: "rgba(180,155,100,0.35)" }} />
                    <span className="text-[9px]" style={{ color: "rgba(180,155,100,0.4)" }}>{d.state}</span>
                  </div>
                )}
              </button>
            ))
        ...
        <div className="rounded-xl p-6 relative overflow-hidden"
          ...
          <div className="relative flex items-start justify-between gap-6 flex-wrap">
            <div>
              ...
              <p className="text-[11px] leading-relaxed max-w-lg" style={{ color: "rgba(180,155,100,0.5)" }}>
  ...
  return (
    <div className="rounded-xl overflow-hidden transition-all duration-200"
      ...
      <button className="w-full flex items-center gap-4 p-4 text-left" onClick={onToggle}>
        ...
        {/* Expand chevron */}
        <div style={{ color: "rgba(180,155,100,0.35)" }}>
          ...
          <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: "auto", opacity: 1 }}
            ...
            <div className="px-4 pb-4 pt-1" style={{ borderTop: "1px solid rgba(212,139,0,0.08)" }}>
              {perfLoading ? (
                ...
                <p className="text-xs py-3 text-center italic" style={{ color: "rgba(180,155,100,0.35)" }}>
                ...
                <>
                  ...
                  {/* Product rows */}
                  <div className="space-y-2">
                    <p className="text-[8px] uppercase tracking-[0.2em] mb-2" style={{ color: "rgba(180,155,100,0.35)" }}>
                      ...
                      <div key={p.id} className="flex items-center gap-3 py-2 px-3 rounded-lg"
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-2 mt-0.5">
                            ...
                            <span className="text-[8px]" style={{ color: "rgba(180,155,100,0.4)" }}>{p.category}</span>
                          </div>
                        </div>
...
function DistributorDetail({ distributor }: { distributor: Distributor }) {
  return (
    <>
      <div>
        <p className="text-[9px] uppercase tracking-[0.2em] mb-0.5" style={{ color: "rgba(180,155,100,0.4)" }}>Distributor</p>
        <p className="font-serif text-base" style={{ color: "rgba(230,210,175,0.85)", fontWeight: 300 }}>{distributor.name}</p>
      </div>
      {distributor.state && (
        <div>
          <p className="text-[9px] uppercase tracking-[0.2em] mb-0.5" style={{ color: "rgba(180,155,100,0.4)" }}>State</p>
          <div className="flex items-center gap-1">
            <MapPin size={10} style={{ color: "rgba(180,155,100,0.4)" }} />
      ...
      {distributor.contactEmail && (
        <div>
          <p className="text-[9px] uppercase tracking-[0.2em] mb-0.5" style={{ color: "rgba(180,155,100,0.4)" }}>Contact</p>
          <div className="flex items-center gap-1">
            <Mail size={10} style={{ color: "rgba(180,155,100,0.4)" }} />
      ...
      {distributor.website && (
        <div>
          <p className="text-[9px] uppercase tracking-[0.2em] mb-0.5" style={{ color: "rgba(180,155,100,0.4)" }}>Website</p>
...
function EmptySlate({ icon, label, sub }: { icon: React.ReactNode; label: string; sub: string }) {
  return (
    <div className="py-10 flex flex-col items-center gap-3 text-center">
      <div style={{ color: "rgba(180,155,100,0.2)" }}>{icon}</div>
      <p className="text-sm font-serif" style={{ color: "rgba(200,180,145,0.45)", fontWeight: 300 }}>{label}</p>
      <p className="text-[10px] max-w-xs" style={{ color: "rgba(180,155,100,0.3)" }}>{sub}</p>
    </div>
  );
}
