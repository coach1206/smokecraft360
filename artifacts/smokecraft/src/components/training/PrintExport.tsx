...
function buildCertificateHTML(data: Record<string, unknown>): string {
  return `
    ...
    ">
      ...
      <div style="font-size: 11px; letter-spacing: 0.15em; text-transform: uppercase; color: #c9a84c; margin-bottom: 8px;">
      ...
      <div style="font-size: 28px; font-weight: 700; color: #c9a84c; border: 2px solid #c9a84c; display: inline-block; padding: 10px 32px; margin-bottom: 28px;">
      ...
      <div style="display: flex; justify-content: space-around; margin-top: 40px; padding-top: 24px; border-top: 1px solid #c9a84c;">
...
function buildInvestorSummaryHTML(): string {
  return `
    <div style="font-family: 'Georgia', serif; max-width: 720px; margin: 0 auto; padding: 40px; background: #fdfaf5;">
      <div style="text-align: center; margin-bottom: 32px; border-bottom: 2px solid #c9a84c; padding-bottom: 24px;">
      ...
      ${[
        ...
        <div style="margin-bottom: 22px;">
          <div style="font-size: 14px; font-weight: 700; color: #c9a84c; margin-bottom: 6px; text-transform: uppercase; letter-spacing: 0.08em;">${title}</div>
    ...
    <div style="font-family: 'Georgia', serif; max-width: 720px; margin: 0 auto; padding: 40px; background: #fdfaf5;">
      ...
      ${steps.map(([title, body], i) => `
        <div style="display: flex; gap: 16px; margin-bottom: 18px; padding-bottom: 18px; border-bottom: 1px solid #eee;">
          <div style="width: 32px; height: 32px; border-radius: 50%; background: #c9a84c; color: #1a1008; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 13px; flex-shrink: 0;">${i + 1}</div>
          <div>
  ...
  w.document.write(`
    ...
    <div style="padding: 32px; text-align: center; margin-bottom: 16px;">
      <button onclick="window.print()" style="
        background: #c9a84c; color: #1a1008; border: none; padding: 10px 24px;
...
export default function PrintExport({ type, data, label, buttonStyle }: PrintExportProps) {
  ...
  function handleExport(subtype: ExportType) {
    ...
    if (subtype === "certificate") {
      ...
      html  = `<div style="font-family:Georgia,serif;max-width:720px;margin:0 auto;padding:40px;"><h1 style="color:#c9a84c;">${data.roleTitle ?? ""} Training Manual</h1><pre style="font-size:12px;line-height:1.7;white-space:pre-wrap;">${JSON.stringify(data, null, 2)}</pre></div>`;
      ...
      {open && (
        <motion.div
          ...
          style={{
            ...
            background: "#0c0914", border: "1px solid rgba(201,168,76,0.2)",
        ...
        >
          ...
          <button onClick={() => setOpen(false)} style={{
            ...
            borderRadius: 7, color: "rgba(240,232,212,0.35)", fontSize: 10,
