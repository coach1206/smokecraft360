...
const STATUS_CONFIG: Record<string, { label: string; color: string; dot: string }> = {
  draft:      { label: "Draft",       color: "rgba(107,94,78,0.68)", dot: "rgba(107,94,78,0.50)" },
    ...
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-[8px]" style={{ color: "rgba(107,94,78,0.35)" }}>
      ...
      {record.adminNotes && (
        <div className="px-3 py-2 rounded-lg" style={{ background: "rgba(212,139,0,0.04)", border: "1px solid rgba(212,139,0,0.12)" }}>
          <p className="text-[8px] uppercase tracking-[0.15em] mb-1" style={{ color: "rgba(107,94,78,0.38)" }}>Note from team</p>
