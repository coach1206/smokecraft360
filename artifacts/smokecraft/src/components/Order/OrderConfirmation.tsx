      ...
      <div className="relative mb-10">
        ...
        <motion.div
          ...
          style={{
            ...
            boxShadow:  "0 0 40px rgba(212,175,55,0.2), 0 0 80px rgba(212,175,55,0.08) inset",
          }}
          initial={{ scale: 0, rotate: -30 }}
          animate={{ scale: 1, rotate: 0 }}
          transition={{ type: "spring", stiffness: 280, damping: 20, delay: 0.15 }}
        >
          <CheckCircle size={36} style={{ color: "rgba(212,175,55,0.9)" }} />
        </motion.div>
      </div>
      ...
      >
        ...
        <div className="flex items-center justify-center gap-2 mb-4">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full"
            ...
            <span style={{ color: "rgba(212,175,55,0.7)" }}>{config.icon}</span>
            <span className="text-xs uppercase tracking-[0.2em]" style={{ color: "rgba(212,175,55,0.75)" }}>
              {config.label}
            </span>
          </div>
        </div>
        ...
        <motion.button
          ...
          whileHover={{ background: "rgba(212,175,55,0.08)", borderColor: "rgba(212,175,55,0.25)", color: "rgba(212,175,55,0.8)" }}
          whileTap={{ scale: 0.97 }}
        >
          Continue
        </motion.button>
