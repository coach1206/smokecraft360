        ...
        <div className="flex flex-wrap gap-1.5 mb-4">
          {product.flavorNotes.slice(0, 3).map((note) => (
            <span key={note} className="px-2.5 py-0.5 text-[10px] rounded-full"
              style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.08)", color: "rgba(210,190,155,0.8)" }}>
              {note}
            </span>
          ))}
          {product.flavorNotes.length > 3 && (
            <span className="px-2.5 py-0.5 text-[10px] rounded-full"
              style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.07)", color: "rgba(180,160,120,0.6)" }}>
              +{product.flavorNotes.length - 3}
            </span>
          )}
        </div>
