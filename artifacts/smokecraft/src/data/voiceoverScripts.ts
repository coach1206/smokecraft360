...
const WALKTHROUGH_SCRIPT: VoiceoverScript = {
  ...
  intro: "Welcome to your Axiom OS venue setup. Over the next 10 steps, we're going to take your venue from a blank configuration to a fully operational, AI-powered experience — live and ready for your first guests. I'll explain what each step does, why it matters, and what happens behind the scenes as we configure it together.",
  cues: [
    { slide: "Step 1: Welcome", duration: "1 min", script: "This is the beginning of your Axiom OS experience. Before we configure anything, I want to tell you what this platform is going to do for your venue. It's going to learn. From your first guest onward, every interaction — every swipe, every recommendation, every order — teaches the system something. Tonight's data makes tomorrow's recommendations better. And tomorrow's data makes next week's better. The system compounds with use." },
  ...
  closing: "That completes the venue walkthrough. From this point, the system runs. Your role as the venue operator is to review the daily KPI strip, act on the alert queue before payout cycles, and coach your team when satisfaction scores dip. The platform handles everything else. Welcome to Axiom OS.",
};
...
const EMPLOYEE_ONBOARDING_SCRIPT: VoiceoverScript = {
  ...
  intro: "Welcome to Vault Cigar Lounge — and to the Axiom OS platform. Before your first shift, we're going to walk you through the system you'll be using every day. I want to start with the most important thing: this platform is not software you manage. It is intelligence that supports you. Your judgment still matters. Your hospitality still matters. Axiom OS just makes everything you do more informed, more efficient, and more effective.",
  cues: [
    { slide: "What Axiom OS Does", duration: "1.5 min", script: "Axiom OS is the brain behind the Vault Cigar Lounge experience. It learns what each guest enjoys, recommends products that match their taste profile, tracks inventory in real time, processes payments, manages loyalty, and generates every report your manager needs to run this venue. Your role is to be the human face of this intelligence — to take what the system knows and deliver it with genuine hospitality." },
