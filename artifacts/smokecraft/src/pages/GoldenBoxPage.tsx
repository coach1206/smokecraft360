...
const JOURNEY = [
  ...
  { id: "master",      num: 6, title: "MASTER OF THE LEAF",sub: "Legendary Status",    xpMin: 35000, color: "#FFD700", glow: "rgba(255,215,0,0.55)",   icon: "⭐", desc: "Become a SmokeCraft legend",xpLabel: "35,000 XP" },
];

const HOW_STEPS = [
  { num: 1, icon: "⚔️", title: "Complete Challenges",   desc: "Take on daily & weekly challenges across SmokeCraft 360" },
...
export default function GoldenBoxPage({ onBack }: GoldenBoxPageProps) {
  ...
  const xp       = guestProfile?.totalMastery ?? 183;
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ padding: "22px 16px 16px", borderBottom: `1px solid rgba(212,175,55,0.10)` }}>
          <div style={{ fontSize: 18, fontWeight: 900, color: GOLD, letterSpacing: "0.05em", lineHeight: 1.1 }}>SMOKECRAFT</div>
          <div style={{ fontSize: 18, fontWeight: 900, color: CREAM, letterSpacing: "0.05em" }}>360</div>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", position: "relative", zIndex: 10 }}>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "6px 12px", borderRadius: 8, background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)" }}>
            ...
            <div>
              <div style={{ fontSize: 13, fontWeight: 700, color: CREAM }}>{guestProfile?.firstName ?? "Guest"}</div>
              ...
              <motion.div key="dashboard"
                ...
                <div style={{ position: "relative", padding: "52px 40px 44px", textAlign: "center", overflow: "hidden", borderBottom: `1px solid rgba(212,175,55,0.10)` }}>
                  ...
                  <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, ease: EASE }}>
                    <div style={{ fontSize: 13, fontWeight: 900, letterSpacing: "0.40em", color: `${GOLD}80`, textTransform: "uppercase", marginBottom: 16 }}>SMOKECRAFT 360 — KIOSK EDITION</div>
