...
const ROLE_CONTENT: Record<string, Array<{ step: string; title: string; body: string }>> = {
  ...
  server: [
    { step: "1", title: "Guest Interaction Basics", body: "Your role is the bridge between the guest and the Axiom platform. Learn to introduce the swipe experience naturally: 'Let me show you something that will make tonight even better.'" },
