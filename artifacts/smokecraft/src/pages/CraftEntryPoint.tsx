          ...
          return (
            ...
            >
              ...
              <div style={{
                ...
                >
                  <p style={{
                    fontFamily: "'Inter',sans-serif", fontSize: 9, letterSpacing: "0.36em",
                    color: `${tile.accent}88`, textTransform: "uppercase", margin: "0 0 10px",
                  }}>
                    {tile.active ? "Select Experience →" : "Not Yet Available"}
                  </p>
                  <p style={{
                    fontFamily: "'Cormorant Garamond',serif", fontSize: 32, fontWeight: 600,
                    color: "#F0E8D4", letterSpacing: "0.06em", margin: "0 0 8px", lineHeight: 1.1,
