  ...
  return (
    <div style={{ marginBottom: 20 }}>
      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8 }}>
        ...
        <span style={{ color: "#d4af37", fontSize: 13, fontWeight: 600 }}>{value}{unit}</span>
      </div>
      <input
        type="range"
        min={min}
  ...
  return (
    <div
      ...
      style={{
        ...
        border: `1px solid ${value ? "rgba(201,168,76,0.3)" : "rgba(255,255,255,0.06)"}`,
    ...
    >
      ...
      <div style={{
        width: 40, height: 22,
        background: value ? "#d4af37" : "rgba(255,255,255,0.12)",
        borderRadius: 11,
        position: "relative",
...
export default function EnvironmentEnginePage() {
  ...
  return (
    <div style={{
      ...
      {/* Top gold rule */}
      <div style={{ position: "fixed", top: 0, left: 0, right: 0, height: 1, background: "linear-gradient(90deg,transparent,rgba(201,168,76,0.6) 30%,rgba(212,175,55,0.9) 50%,rgba(201,168,76,0.6) 70%,transparent)", zIndex: 10 }} />
      ...
      <div style={{ position: "relative", zIndex: 5 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12, padding: "18px 24px 0" }}>
          <button
            ...
            style={{
              ...
              color: "rgba(240,232,212,0.75)", padding: "7px 14px", borderRadius: 8,
          ...
          <div style={{ flex: 1 }}>
            <h1 style={{ margin: 0, fontSize: "clamp(18px,4vw,26px)", fontWeight: 500, letterSpacing: "0.06em", color: "#d4af37" }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            borderRadius: 20, fontSize: 12, color: "#d4af37", letterSpacing: "0.08em",
          }}>
          ...
          <div style={{
            padding: "6px 14px",
            background: env.automationEnabled ? "rgba(34,197,94,0.1)" : "rgba(255,255,255,0.04)",
            border: `1px solid ${env.automationEnabled ? "rgba(34,197,94,0.3)" : "rgba(255,255,255,0.08)"}`,
            borderRadius: 20, fontSize: 12, letterSpacing: "0.08em",
          ...
          <motion.button
            ...
            style={{
              ...
              background: vipFlash ? "rgba(212,175,55,0.25)" : "rgba(212,175,55,0.08)",
              border: `1px solid ${vipFlash ? "rgba(212,175,55,0.6)" : "rgba(212,175,55,0.25)"}`,
        ...
        {/* Tab bar */}
        <div style={{ display: "flex", gap: 2, padding: "18px 24px 0", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
          {TABS.map(t => (
            <button
              key={t}
              ...
              style={{
                ...
                color: tab === t ? "#d4af37" : "rgba(240,232,212,0.45)",
      ...
      <div style={{ position: "relative", zIndex: 5, padding: "24px 24px 80px" }}>
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {tab === "Energy State" && (
              <div>
                <p style={{ margin: "0 0 20px", fontSize: 13, color: "rgba(240,232,212,0.45)", letterSpacing: "0.06em" }}>
                    ...
                    return (
                      <motion.div
                        ...
                        style={{
                          ...
                          cursor: "pointer",
                          transition: "all 0.2s ease",
                          boxShadow: active ? "0 0 18px rgba(201,168,76,0.1)" : "none",
                        }}
                      >
                        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 8 }}>
                          <span style={{ fontSize: 22, opacity: active ? 1 : 0.6 }}>{cfg.icon}</span>
                          <span style={{ fontSize: 14, fontWeight: 600, color: active ? "#d4af37" : "rgba(240,232,212,0.85)", letterSpacing: "0.04em" }}>{cfg.label}</span>
                          {active && <span style={{ marginLeft: "auto", fontSize: 10, color: "#d4af37", letterSpacing: "0.1em" }}>ACTIVE</span>}
                        </div>
                    ...
                    return (
                      <motion.div
                        ...
                        style={{
                          ...
                          border: `1px solid ${active ? cfg.color + "66" : "rgba(255,255,255,0.07)"}`,
                      ...
                      >
                        ...
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 8 }}>
                          <span style={{ fontSize: 15, fontWeight: 600, color: active ? cfg.color : "rgba(240,232,212,0.85)", letterSpacing: "0.04em" }}>
                            {cfg.label}
                          </span>
                          {active && <span style={{ fontSize: 10, color: cfg.color, letterSpacing: "0.1em" }}>ACTIVE</span>}
                        </div>
                        <div style={{ fontSize: 12, color: "rgba(240,232,212,0.45)", lineHeight: 1.5 }}>{cfg.description}</div>
            ...
            {tab === "Controls" && (
              <div style={{ maxWidth: 580 }}>
                <p style={{ margin: "0 0 24px", fontSize: 13, color: "rgba(240,232,212,0.45)", letterSpacing: "0.06em" }}>
                    ...
                    {(["bold", "smooth", "balanced"] as MentorPersonality[]).map(p => (
                      <motion.button
                        ...
                        style={{
                          ...
                          background: env.mentorPersonality === p ? "rgba(201,168,76,0.15)" : "rgba(255,255,255,0.04)",
                          border: `1px solid ${env.mentorPersonality === p ? "rgba(201,168,76,0.45)" : "rgba(255,255,255,0.08)"}`,
                          color: env.mentorPersonality === p ? "#d4af37" : "rgba(240,232,212,0.55)",
                ...
                <motion.button
                  ...
                  style={{
                    ...
                    color: "#d4af37", fontSize: 14, cursor: "pointer", letterSpacing: "0.08em",
                      ...
                      <Section title="Energy State Distribution">
                        {Object.entries(a.energyStateDistribution).map(([k, v]) => (
                          <div key={k} style={{ marginBottom: 10 }}>
                            <div style={{ display: "flex", justifyContent: "space-between", fontSize: 12, marginBottom: 4, color: "rgba(240,232,212,0.65)" }}>
                              <span>{ENERGY_STATE_CONFIG[k as EnergyState]?.label ?? k}</span>
                              <span style={{ color: "#d4af37" }}>{v}%</span>
                            </div>
                      ...
                      <Section title="Event Atmosphere ROI">
                        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(200px,1fr))", gap: 10 }}>
                          {Object.entries(a.eventAtmosphereRoi).map(([k, v]) => (
                            <div key={k} style={{ padding: "14px 16px", background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 10 }}>
                              ...
                              <div style={{ fontSize: 13, color: "#d4af37" }}>{v.avgOrderValue} avg order</div>
                            </div>
                          ))}
                        </div>
                      </Section>
      ...
      {/* ── Emergency Reset ── */}
      <div style={{ position: "fixed", bottom: 0, left: 0, right: 0, zIndex: 10, padding: "12px 24px", background: "rgba(6,4,10,0.94)", borderTop: "1px solid rgba(255,255,255,0.06)", display: "flex", justifyContent: "flex-end" }}>
        <motion.button
          whileTap={{ scale: 0.97 }}
          onClick={handleReset}
          style={{
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div style={{ marginBottom: 28 }}>
      <div style={{ fontSize: 11, color: "rgba(201,168,76,0.6)", letterSpacing: "0.15em", marginBottom: 14, textTransform: "uppercase" }}>{title}</div>
      {children}
    </div>
  );
}
...
function Meter({ label, value }: { label: string; value: number }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 5 }}>
      <span style={{ fontSize: 10, color: "rgba(240,232,212,0.35)", letterSpacing: "0.05em" }}>{label}</span>
      <div style={{ width: 36, height: 3, background: "rgba(255,255,255,0.08)", borderRadius: 2 }}>
        <div style={{ width: `${Math.round(value)}%`, height: "100%", background: "#c9a84c", borderRadius: 2 }} />
      </div>
    </div>
  );
}
...
function StatCard({ label, value }: { label: string; value: string }) {
  return (
    <div style={{ padding: "18px 20px", background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 12 }}>
      <div style={{ fontSize: 11, color: "rgba(240,232,212,0.4)", letterSpacing: "0.1em", marginBottom: 6 }}>{label.toUpperCase()}</div>
      <div style={{ fontSize: 24, color: "#d4af37", fontWeight: 600 }}>{value}</div>
    </div>
  );
}
