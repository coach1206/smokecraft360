...
import { NoveeLeaderboardTicker } from "@/components/NoveeLeaderboardTicker";
import { NoveePOSGateModal } from "@/components/NoveePOSGateModal";
...
export function S1_InitGate() {
  ...
  return (
    <div style={{ position: "absolute", inset: 0, fontFamily: "'Inter', sans-serif", overflow: "hidden" }}>
      ...
      {showPOS && <NoveePOSGateModal onUnlock={handlePOSUnlock} />}
    </div>
  );
}
