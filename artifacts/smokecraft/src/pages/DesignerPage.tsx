...
const WOODS = {
  ...
  mahogany: {
    ...
    grain: "repeating-linear-gradient(83deg, transparent 0px, transparent 7px, rgba(0,0,0,0.1) 7px, rgba(0,0,0,0.1) 8px)",
    highlight: "#c05840",
  },
  walnut: {
  ...
  ebony: {
    ...
    grain: "repeating-linear-gradient(88deg, transparent 0px, transparent 14px, rgba(255,255,255,0.04) 14px, rgba(255,255,255,0.04) 15px)",
    highlight: "#4a3828",
  },
} as const;
...
const TRIMS = {
  gold: {
    id: "gold", name: "Gold",
    color: "#d4af37", light: "#f0d060", shadow: "#8a6f1a",
    ...
    <div style={{ width: "100%", perspective: "720px", perspectiveOrigin: "50% 35%" }}>
      <div style={{ position: "relative", maxWidth: 480, margin: "0 auto", height: 240 }}>
        ...
        <div style={{
          ...
          overflow: "hidden",
          boxShadow: `0 12px 40px rgba(0,0,0,0.55), inset 0 1px 0 ${wood.highlight}40`,
        }}>
                ...
                {Array.from({ length: 8 }).map((_, col) => (
                  <motion.div
                    ...
                    style={{
                      ...
                      boxShadow: `0 2px 5px ${interior.cigarShadow}, inset 0 1px 0 rgba(255,255,255,0.18)`,
                    }}
                  />
                ))}
              </div>
        ...
        <motion.div
          ...
          style={{
            ...
            borderRadius: 14,
            overflow: "hidden",
            boxShadow: `0 8px 32px rgba(0,0,0,0.5), inset 0 1px 0 ${wood.highlight}60`,
            zIndex: isOpen ? 0 : 12,
          }}
        >
          {/* Inner frame / recess */}
          ...
          <div style={{
            ...
            <div style={{
              ...
              color: trim.light,
              textShadow: `0 -1px 0 rgba(0,0,0,0.6), 0 1px 3px ${trim.light}50, 0 0 12px ${trim.glow}`,
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 12, padding: "24px 0" }}>
      <svg viewBox="0 0 200 300" width={200} height={300}>
        ...
        {/* Glass body */}
        <path d="M55 50 L45 260 L155 260 L145 50 Z" fill="rgba(255,255,255,0.08)" stroke="rgba(255,255,255,0.2)" strokeWidth="1.5" />
        {/* Beer */}
  ...
  return (
    <motion.button
      ...
      style={{
        ...
        border: active ? `1.5px solid ${color ?? "#d4af37"}` : "1.5px solid rgba(255,255,255,0.1)",
        background: active ? `${color ?? "#d4af37"}14` : "rgba(255,255,255,0.03)",
        color: "#fff", fontSize: 12, fontWeight: active ? 700 : 500,
        display: "flex", alignItems: "center", gap: 6,
      }}
    >
      {active && <Check size={11} color={color ?? "#d4af37"} />}
      {children}
    </motion.button>
  );
}
...
export default function DesignerPage() {
  ...
  return (
    <div style={{
      minHeight: "100dvh",
      background: "radial-gradient(ellipse at 30% 20%, #1a1208 0%, #0a0806 60%, #050402 100%)",
      color: "#e8e0c8",
          ...
          {CRAFT_TYPES.map(c => (
            <motion.button key={c.id} type="button" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}
              ...
              style={{
                ...
                background: craft === c.id ? `${accent}14` : "rgba(255,255,255,0.03)",
                ...
                {Object.values(WOODS).map(w => (
                  <motion.button key={w.id} type="button" whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.96 }}
                    ...
                    style={{
                      ...
                      background: wood === w.id ? `${accent}14` : "rgba(255,255,255,0.03)",
