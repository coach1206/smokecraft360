/**
 * deviceTelemetry.ts — Device heartbeat and telemetry client.
 *
 * Sends POST /api/device-heartbeat every 30s so this kiosk/tablet
 * remains ACTIVE in the backend device registry.
 * Exposes a hook for subscribing to live device statuses across the venue.
 */
