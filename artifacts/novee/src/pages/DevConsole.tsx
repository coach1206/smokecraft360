/**
 * DevConsole — Developer Remote Protocol terminal (NOVEE OS).
 * Connects to the /developer Socket.io namespace.
 * Requires developer or super_admin JWT.
 * Uses phase-based navigation (setPhase) instead of wouter.
 */
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: 1060, margin: "0 auto", padding: "0 16px 48px" }}>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            <motion.button whileTap={{ scale: 0.94 }} onClick={() => setPhase("control-chamber")}
              style={{
                ...
                <div style={{
                  ...
                  {log.map(e => (
                    <div key={e.id} style={{ display: "flex", gap: 10, fontSize: 18, lineHeight: 1.5, fontFamily: GFONT }}>
                      ...
                      <span style={{ color: kindColor(e.kind), fontWeight: 700, flexShrink: 0, minWidth: 26, textAlign: "center" }}>
