...
export function S3_FormulationLab() {
  const { updateProfile, setPhase, addPoints, profile } = useGuest();
  ...
  return (
    <div style={{
      ...
      <img src={`${import.meta.env.BASE_URL}images/cigar_hero.jpg`} alt="" aria-hidden
        style={{ position: "absolute", inset: "8% 5%", width: "90%", height: "84%", objectFit: "contain", objectPosition: "center center", opacity: 0.20, pointerEvents: "none" }}
            ...
            >
              ...
              <div style={{ position: "relative", width: 300, height: 300, margin: "0 auto" }}>
                 <motion.div 
                   ...
                   style={{ position: "absolute", inset: 0, background: `radial-gradient(circle, ${GOLD}33, transparent 70%)` }}
                 />
              ...
              <div style={{ 
                ...
                overflow: "hidden"
                 ...
                 <div style={{ display: "flex", flexDirection: "column", gap: 15, position: "relative" }}>
                    <button 
                      onPointerDown={() => { touch(); setPhase("s4_results"); }}
                    ...
                    {profile.skipTokens > 0 && profile.pairingHistory.filter(p => p.xp >= 20).length >= 3 && (
                      <motion.button
                        ...
                        onPointerDown={() => { touch(); updateProfile({ skipTokens: profile.skipTokens - 1 }); setPhase("s4_results"); }}
