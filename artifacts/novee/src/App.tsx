...
const NAV_ITEMS: NavItem[] = [
  ...
  { id: "smokecraft",        label: "SmokeCraft",           abbr: "SC",  targetPhase: "s1_demo",           isActive: (p) => SESSION_PHASES.has(p) },
  { id: "eat",               label: "E.A.T Intel",          abbr: "EAT", targetPhase: "eat_dashboard",     pinLevel: "staff",      isActive: (p) => p === "eat_dashboard" },
  { id: "executive_command", label: "Command Center",       abbr: "EXC", targetPhase: "executive_command", pinLevel: "management", isActive: (p) => p === "executive_command" },
  { id: "pairing",           label: "Pairing",              abbr: "PR",  targetPhase: "pairing_view",      isActive: (p) => p === "pairing_view" },
  { id: "lounge",            label: "Lounge",               abbr: "LG",  targetPhase: "lounge_view",       isActive: (p) => p === "lounge_view" },
  { id: "profile",           label: "My Profile",           abbr: "ME",  targetPhase: "profile_view",      isActive: (p) => p === "profile_view" },
  { id: "settings",          label: "Settings",             abbr: "ST",  targetPhase: "settings_view",     isActive: (p) => p === "settings_view" },
];
