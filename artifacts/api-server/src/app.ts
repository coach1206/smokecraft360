...
import themeConfigSyncRouter from "./routes/themeConfigSync";
...
import venueIntelligenceEatRouter from "./routes/venueIntelligenceEat";
...
import sniperNetworkRouter         from "./routes/sniperNetwork";
import integrationKernelRouter     from "./routes/integrationKernel";
...
app.use("/api/theme-config",               themeConfigSyncRouter);
...
app.use("/api/venue-intelligence",          requireAuth, venueIntelligenceEatRouter);
...
app.use("/api/sniper",            sniperNetworkRouter);
app.use("/api/integration-kernel", integrationKernelRouter);
